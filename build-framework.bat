...
set BIN_DIR=.\bin
REM Le repertoire de test 
set TESTPROJECT_LIB=E:\ITU\S6\Sprint Framework\Test\lib
...
REM Deployer le fichier jar dans le projet de test
xcopy /Y "%JAR_NAME%" "%TESTPROJECT_LIB%"
